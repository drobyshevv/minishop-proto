...
const file_users_users_proto_rawDesc = "" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name2\x8a\x01\n" +
	"\vUserService\x12A\n" +
	"\n" +
	"CreateUser\x12\x18.users.CreateUserRequest\x1a\x19.users.CreateUserResponse\x128\n" +
	"\aGetUser\x12\x15.users.GetUserRequest\x1a\x16.users.GetUserResponseB3Z1github.com/drobyshevv/minishop-proto/users;userpbb\x06proto3"
...
var file_users_users_proto_depIdxs = []int32{
	...
	3, // 4: users.UserService.GetUser:output_type -> users.GetUserResponse
